    ...
    <section>
        <div class="">
            <div class="max-w-lg mx-auto flex mb-4 stroke-white">
                <ChevronLeft class="w-16 h-16 cursor-pointer rounded-full hover:bg-gray hover:bg-opacity-10"
                    @click="incrementMonth(-1)"></ChevronLeft>
                <p class="w-full text-center text-xl my-auto font-medium uppercase">
                    {{
                ...
                <ChevronRight class="w-16 h-16 cursor-pointer rounded-full hover:bg-gray hover:bg-opacity-10"
                    @click="incrementMonth(1)"></ChevronRight>
            </div>
            <div class="p-4 flex flex-col max-w-lg mx-auto">
                <div class="flex mb-4 w-full">
                    <div v-for="day in weeks[0]"
                ...
                <div v-for="week in weeksComputed" class="flex mx-auto w-full">
                    <div v-for="day in week"
                        ...
                        <div class="w-full absolute top-0 z-0">
                            <div class="bg-opacity-20 h-8 z-0" :class="[
                                day.in
                                    ? 'bg-gray'
                                    : day.start
                        ...
                        <div class="h-8 aspect-square mx-auto rounded-full font-bold z-10" :class="[
                        ...
                        <div class="flex p-2">
                            <div class="h-2 w-2 rounded-full mx-auto" :class="[
...
const startEvent = (date: Date) => {
    ...
    for (const e of events) {
        ...
        const start = parseInt(isoDateString(new Date(e.start)).substring(8, 10))
        if (start === day) {
            return e.start
        }
    }

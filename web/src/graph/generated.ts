...
export type DefaultGridSection = GridSection &
    ItemSection &
    Section & {
        id: Scalars["ID"]
...
export type LabelSection = ItemSection &
    Section & {
        id: Scalars["ID"]
        items: SectionItemPagination
        metadata?: Maybe<ItemSectionMetadata>
...
export type PosterGridSection = GridSection &
    ItemSection &
    Section & {
        id: Scalars["ID"]
        items: SectionItemPagination
...
type ItemSection_DefaultGridSection_Fragment = {
    ...
    metadata?: { collectionId: string } | null
    items: {
        items: Array<{
            id: string
            image?: string | null
...
export function useGetAnalyticsIdQuery(
    options: Omit<
        Urql.UseQueryArgs<never, GetAnalyticsIdQueryVariables>,
        "query"
    > = {}
) {
    return Urql.useQuery<GetAnalyticsIdQuery>({
        query: GetAnalyticsIdDocument,
        ...options,
    })
}
...
export function useGetRedirectUrlQuery(
    options: Omit<
        Urql.UseQueryArgs<never, GetRedirectUrlQueryVariables>,
        "query"
    > = {}
) {
    return Urql.useQuery<GetRedirectUrlQuery>({
        query: GetRedirectUrlDocument,
        ...options,
    })
}
...
export function useGetDefaultEpisodeIdQuery(
    options: Omit<
        Urql.UseQueryArgs<never, GetDefaultEpisodeIdQueryVariables>,
        "query"
    > = {}
) {
    return Urql.useQuery<GetDefaultEpisodeIdQuery>({
        query: GetDefaultEpisodeIdDocument,
        ...options,
    })
}

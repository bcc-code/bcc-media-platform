...
export type EpisodeItemFragment = { item?: { episodeNumber?: number | null, season?: { number: number, show: { title: string } } | null } | {} | null };


export type EpisodeItemFragmentVariables = Exact<{ [key: string]: never; }>;

export type SeasonItemFragment = { item?: { seasonNumber: number, show: { title: string } } | {} | null };
...
type Section_DefaultSection_Fragment = { __typename: 'DefaultSection', items: { items: Array<{ __typename: 'SectionItem', id: string, title: string, image?: string | null, sort: number, item?: { __typename: 'Episode', episodeNumber?: number | null, season?: { number: number, show: { title: string } } | null } | { __typename: 'Page', code: string } | { __typename: 'Season', seasonNumber: number, show: { title: string } } | { __typename: 'Show', title: string } | null }> } };

type Section_FeaturedSection_Fragment = { __typename: 'FeaturedSection', items: { items: Array<{ __typename: 'SectionItem', id: string, title: string, image?: string | null, sort: number, item?: { __typename: 'Episode', episodeNumber?: number | null, season?: { number: number, show: { title: string } } | null } | { __typename: 'Page', code: string } | { __typename: 'Season', seasonNumber: number, show: { title: string } } | { __typename: 'Show', title: string } | null }> } };

type Section_GridSection_Fragment = { __typename: 'GridSection', items: { items: Array<{ __typename: 'SectionItem', id: string, title: string, image?: string | null, sort: number, item?: { __typename: 'Episode', episodeNumber?: number | null, season?: { number: number, show: { title: string } } | null } | { __typename: 'Page', code: string } | { __typename: 'Season', seasonNumber: number, show: { title: string } } | { __typename: 'Show', title: string } | null }> } };

type Section_PosterSection_Fragment = { __typename: 'PosterSection', items: { items: Array<{ __typename: 'SectionItem', id: string, title: string, image?: string | null, sort: number, item?: { __typename: 'Episode', episodeNumber?: number | null, season?: { number: number, show: { title: string } } | null } | { __typename: 'Page', code: string } | { __typename: 'Season', seasonNumber: number, show: { title: string } } | { __typename: 'Show', title: string } | null }> } };

export type SectionFragment = Section_DefaultSection_Fragment | Section_FeaturedSection_Fragment | Section_GridSection_Fragment | Section_PosterSection_Fragment;
...
export type GetPageQuery = { page: { id: string, title: string, sections: { items: Array<{ __typename: 'DefaultSection', id: string, title?: string | null, items: { items: Array<{ __typename: 'SectionItem', id: string, title: string, image?: string | null, sort: number, item?: { __typename: 'Episode', episodeNumber?: number | null, season?: { number: number, show: { title: string } } | null } | { __typename: 'Page', code: string } | { __typename: 'Season', seasonNumber: number, show: { title: string } } | { __typename: 'Show', title: string } | null }> } } | { __typename: 'FeaturedSection', id: string, title?: string | null, items: { items: Array<{ __typename: 'SectionItem', id: string, title: string, image?: string | null, sort: number, item?: { __typename: 'Episode', episodeNumber?: number | null, season?: { number: number, show: { title: string } } | null } | { __typename: 'Page', code: string } | { __typename: 'Season', seasonNumber: number, show: { title: string } } | { __typename: 'Show', title: string } | null }> } } | { __typename: 'GridSection', id: string, title?: string | null, items: { items: Array<{ __typename: 'SectionItem', id: string, title: string, image?: string | null, sort: number, item?: { __typename: 'Episode', episodeNumber?: number | null, season?: { number: number, show: { title: string } } | null } | { __typename: 'Page', code: string } | { __typename: 'Season', seasonNumber: number, show: { title: string } } | { __typename: 'Show', title: string } | null }> } } | { __typename: 'IconSection', id: string, title?: string | null } | { __typename: 'LabelSection', id: string, title?: string | null } | { __typename: 'PosterSection', id: string, title?: string | null, items: { items: Array<{ __typename: 'SectionItem', id: string, title: string, image?: string | null, sort: number, item?: { __typename: 'Episode', episodeNumber?: number | null, season?: { number: number, show: { title: string } } | null } | { __typename: 'Page', code: string } | { __typename: 'Season', seasonNumber: number, show: { title: string } } | { __typename: 'Show', title: string } | null }> } }> } } };

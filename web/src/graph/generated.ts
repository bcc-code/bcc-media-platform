...
export type Episode = CollectionItem & PlaylistItem & {
...
export type Short = CollectionItem & PlaylistItem & {
  description?: Maybe<Scalars['String']>;
  files: Array<File>;
  id: Scalars['ID'];
  image?: Maybe<Scalars['String']>;

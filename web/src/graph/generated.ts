...
export type SectionItemFragment = { item?: { __typename: 'Episode', episodeNumber?: number | null, season?: { number: number, show: { title: string } } | null } | { __typename: 'Page', code: string } | { __typename: 'Season', seasonNumber: number, show: { title: string } } | { __typename: 'Show' } | null };


export type SectionItemFragmentVariables = Exact<{ [key: string]: never; }>;

type ItemSection_DefaultSection_Fragment = { size: SectionSize, items: { items: Array<{ id: string, image?: string | null, title: string, sort: number, item?: { __typename: 'Episode', episodeNumber?: number | null, season?: { number: number, show: { title: string } } | null } | { __typename: 'Page', code: string } | { __typename: 'Season', seasonNumber: number, show: { title: string } } | { __typename: 'Show' } | null }> } };

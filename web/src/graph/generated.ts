...
export type SectionItemType = Episode | Game | Link | Page | Season | Show | StudyTopic;
...
export type UserCollectionEntry = {
  id: Scalars['UUID'];
  item: UserCollectionEntryItem;
};

export type UserCollectionEntryItem = Episode | Show;

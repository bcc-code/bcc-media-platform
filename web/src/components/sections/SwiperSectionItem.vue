<template>
    <div>
        <div class="rounded rounded-xl aspect-video bg-cover bg-center bg-no-repeat" :style="{
        ...
        <div class="mt-2">
            <div class="text-sm truncate text-primary">
                ...
                ">
                    ...
                    <span class="text-sm text-gray">S{{ item.episode.season.number }}:E{{
                    item.episode.number
                    }}</span>
                </p>
                <p v-else-if="
                ...
                ">
                    ...
                    <span class="text-sm text-gray">S{{ item.season.number }}</span>
                </p>

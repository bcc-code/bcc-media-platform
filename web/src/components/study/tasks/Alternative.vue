<template>
    ...
    conditionalClass
">
        <p class="w-5 text-2xl font-extrabold leading-7 text-center text-label-3">
            {{ letter }}
        </p>
        ...
        <div class="flex items-center justify-center p-1.5 pr-4">
            ...
            <svg v-else-if="props.selected && props.correct" width="15" height="12" viewBox="0 0 15 12" fill="none"
                xmlns="http://www.w3.org/2000/svg">

    ...
    <div class="w-full h-full">
        ...
        >
            ...
            <div
                ...
                "
                class="flex flex-col items-center justify-center w-full h-full pb-8 embed:pb-64 embed:min-h-screen"
            >
        ...
        >
            <div class="inline-flex space-x-2 items-start justify-start w-full">
                ...
                <VButton
                    ...
                    @click="
                        () => {
                            hijackWithCompetitionIntro = false
...
const {
    executeMutation: executeLockAnswersMutation,
    fetching: lockingInProgress,
    data: lockData,
} = useLockAnswersMutation()
...
const hijackWithCompetitionIntro = ref(
    currentTask.value.__typename == "AlternativesTask"
)
...
const lockAnswers = async () => {
    ...
    const result = await executeLockAnswersMutation({

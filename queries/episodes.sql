...
SELECT e.id,
       ...
       COALESCE(ea.available_from, '1970-01-01')::timestamp without time zone                       AS available_from,
       COALESCE(ea.available_to, '9999-12-31')::timestamp without time zone                         AS available_to,
       mi.asset_id,
       mi.assets,
       mi.published_at,
       mi.production_date,

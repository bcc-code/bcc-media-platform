...
CREATE TABLE IF NOT EXISTS "public"."mediaitems_usergroups" (
	...
	CONSTRAINT "mediaitems_usergroups_usergroups_code_foreign" FOREIGN KEY (usergroups_code) REFERENCES usergroups(code) ON DELETE SET NULL ,
	CONSTRAINT "mediaitems_usergroups_mediaitems_id_foreign" FOREIGN KEY (mediaitems_id) REFERENCES mediaitems(id) ON DELETE SET NULL
);
...
ALTER TABLE IF EXISTS "public"."mediaitems" ADD COLUMN IF NOT EXISTS "available_from" timestamp NULL  ;

COMMENT ON COLUMN "public"."mediaitems"."available_from"  IS NULL;

ALTER TABLE IF EXISTS "public"."mediaitems" ADD COLUMN IF NOT EXISTS "available_to" timestamp NULL  ;
...
UPDATE "public"."directus_fields" SET "sort" = 14 WHERE "id" = 483;

UPDATE "public"."directus_fields" SET "sort" = 17 WHERE "id" = 130;

UPDATE "public"."directus_fields" SET "sort" = 6 WHERE "id" = 1459;

UPDATE "public"."directus_fields" SET "sort" = 10 WHERE "id" = 120;

UPDATE "public"."directus_fields" SET "sort" = 15 WHERE "id" = 1460;

INSERT INTO "public"."directus_fields" ("id", "collection", "field", "special", "interface", "options", "display", "display_options", "readonly", "hidden", "sort", "width", "translations", "note", "conditions", "required", "group", "validation", "validation_message")  VALUES (1466, 'mediaitems', 'availability', 'alias,no-data,group', 'group-detail', NULL, NULL, NULL, false, false, 11, 'full', NULL, NULL, NULL, false, NULL, NULL, NULL);

INSERT INTO "public"."directus_fields" ("id", "collection", "field", "special", "interface", "options", "display", "display_options", "readonly", "hidden", "sort", "width", "translations", "note", "conditions", "required", "group", "validation", "validation_message")  VALUES (1471, 'mediaitems', 'available_from', NULL, 'custom-datepicker', NULL, 'datetime', NULL, false, false, 1, 'half', NULL, NULL, NULL, false, 'availability', NULL, NULL);

UPDATE "public"."directus_fields" SET "hidden" = true, "sort" = 7 WHERE "id" = 144;

UPDATE "public"."directus_fields" SET "hidden" = true, "sort" = 8 WHERE "id" = 137;

UPDATE "public"."directus_fields" SET "sort" = 16 WHERE "id" = 143;

INSERT INTO "public"."directus_fields" ("id", "collection", "field", "special", "interface", "options", "display", "display_options", "readonly", "hidden", "sort", "width", "translations", "note", "conditions", "required", "group", "validation", "validation_message")  VALUES (1468, 'mediaitems_usergroups', 'id', NULL, NULL, NULL, NULL, NULL, false, true, 1, 'full', NULL, NULL, NULL, false, NULL, NULL, NULL);

INSERT INTO "public"."directus_fields" ("id", "collection", "field", "special", "interface", "options", "display", "display_options", "readonly", "hidden", "sort", "width", "translations", "note", "conditions", "required", "group", "validation", "validation_message")  VALUES (1469, 'mediaitems_usergroups', 'mediaitems_id', NULL, NULL, NULL, NULL, NULL, false, true, 2, 'full', NULL, NULL, NULL, false, NULL, NULL, NULL);

INSERT INTO "public"."directus_fields" ("id", "collection", "field", "special", "interface", "options", "display", "display_options", "readonly", "hidden", "sort", "width", "translations", "note", "conditions", "required", "group", "validation", "validation_message")  VALUES (1470, 'mediaitems_usergroups', 'usergroups_code', NULL, NULL, NULL, NULL, NULL, false, true, 3, 'full', NULL, NULL, NULL, false, NULL, NULL, NULL);

INSERT INTO "public"."directus_fields" ("id", "collection", "field", "special", "interface", "options", "display", "display_options", "readonly", "hidden", "sort", "width", "translations", "note", "conditions", "required", "group", "validation", "validation_message")  VALUES (1467, 'mediaitems', 'usergroups', 'm2m', 'list-m2m', NULL, 'related-values', NULL, false, false, 3, 'full', NULL, NULL, NULL, false, 'availability', NULL, NULL);

UPDATE "public"."directus_fields" SET "sort" = 9 WHERE "id" = 1378;

INSERT INTO "public"."directus_fields" ("id", "collection", "field", "special", "interface", "options", "display", "display_options", "readonly", "hidden", "sort", "width", "translations", "note", "conditions", "required", "group", "validation", "validation_message")  VALUES (1472, 'mediaitems', 'available_to', NULL, 'custom-datepicker', NULL, 'datetime', NULL, false, false, 2, 'half', NULL, NULL, NULL, false, 'availability', NULL, NULL);
...
UPDATE "public"."directus_fields" SET "sort" = 12 WHERE "id" = 1442;

UPDATE "public"."directus_fields" SET "hidden" = true, "sort" = 11 WHERE "id" = 1314;

UPDATE "public"."directus_fields" SET "sort" = 16 WHERE "id" = 1422;
...
INSERT INTO "public"."directus_collections" ("collection", "icon", "note", "display_template", "hidden", "singleton", "translations", "archive_field", "archive_app_filter", "archive_value", "unarchive_value", "sort_field", "accountability", "color", "item_duplication_fields", "sort", "group", "collapse", "preview_url", "versioning")  VALUES ('mediaitems_usergroups', 'import_export', NULL, NULL, true, false, NULL, NULL, true, NULL, NULL, NULL, 'all', NULL, NULL, NULL, NULL, 'open', NULL, false);

--- END SYNCHRONIZE TABLE "public"."directus_collections" RECORDS ---

--- BEGIN SYNCHRONIZE TABLE "public"."directus_relations" RECORDS ---

INSERT INTO "public"."directus_relations" ("id", "many_collection", "many_field", "one_collection", "one_field", "one_collection_field", "one_allowed_collections", "junction_field", "sort_field", "one_deselect_action")  VALUES (447, 'mediaitems_usergroups', 'usergroups_code', 'usergroups', NULL, NULL, NULL, 'mediaitems_id', NULL, 'nullify');

INSERT INTO "public"."directus_relations" ("id", "many_collection", "many_field", "one_collection", "one_field", "one_collection_field", "one_allowed_collections", "junction_field", "sort_field", "one_deselect_action")  VALUES (448, 'mediaitems_usergroups', 'mediaitems_id', 'mediaitems', 'usergroups', NULL, NULL, 'usergroups_code', NULL, 'nullify');
...
ALTER TABLE IF EXISTS "public"."mediaitems" DROP COLUMN IF EXISTS "available_from" CASCADE; --WARN: Drop column can occure in data loss!

ALTER TABLE IF EXISTS "public"."mediaitems" DROP COLUMN IF EXISTS "available_to" CASCADE; --WARN: Drop column can occure in data loss!
...
DELETE FROM "public"."directus_collections" WHERE "collection" = 'mediaitems_usergroups';
...
UPDATE "public"."directus_fields" SET "sort" = 16 WHERE "id" = 130;

UPDATE "public"."directus_fields" SET "hidden" = false, "sort" = 6 WHERE "id" = 144;

UPDATE "public"."directus_fields" SET "hidden" = false, "sort" = 7 WHERE "id" = 137;
...
UPDATE "public"."directus_fields" SET "hidden" = false, "sort" = 10 WHERE "id" = 1314;

UPDATE "public"."directus_fields" SET "sort" = 8 WHERE "id" = 1378;

UPDATE "public"."directus_fields" SET "sort" = 15 WHERE "id" = 1422;

UPDATE "public"."directus_fields" SET "sort" = 12 WHERE "id" = 1435;

UPDATE "public"."directus_fields" SET "sort" = 13 WHERE "id" = 483;

UPDATE "public"."directus_fields" SET "sort" = 11 WHERE "id" = 1442;

UPDATE "public"."directus_fields" SET "sort" = 17 WHERE "id" = 1459;

UPDATE "public"."directus_fields" SET "sort" = 13 WHERE "id" = 1460;

DELETE FROM "public"."directus_fields" WHERE "id" = 1466;

DELETE FROM "public"."directus_fields" WHERE "id" = 1471;

DELETE FROM "public"."directus_fields" WHERE "id" = 1468;

DELETE FROM "public"."directus_fields" WHERE "id" = 1469;

DELETE FROM "public"."directus_fields" WHERE "id" = 1470;

DELETE FROM "public"."directus_fields" WHERE "id" = 1467;

DELETE FROM "public"."directus_fields" WHERE "id" = 1472;

--- END SYNCHRONIZE TABLE "public"."directus_fields" RECORDS ---

--- BEGIN SYNCHRONIZE TABLE "public"."directus_relations" RECORDS ---

DELETE FROM "public"."directus_relations" WHERE "id" = 447;

DELETE FROM "public"."directus_relations" WHERE "id" = 448;

...
func (r *lessonResolver) Tasks(ctx context.Context, obj *model.Lesson, first *int, offset *int, cursor *string) (*model.TaskPagination, error) {
...
func (r *lessonResolver) Episodes(ctx context.Context, obj *model.Lesson, first *int, offset *int, cursor *string) (*model.EpisodePagination, error) {
...
func (r *lessonResolver) Links(ctx context.Context, obj *model.Lesson, first *int, offset *int, cursor *string) (*model.LinkPagination, error) {
...
func (r *studyTopicResolver) Lessons(ctx context.Context, obj *model.StudyTopic, first *int, offset *int, cursor *string) (*model.LessonPagination, error) {

...
func (_m *MockTranslationsProvider) ProcessWebhook(ctx context.Context, url string, hookData []byte) (string, []common.TranslationData, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, []byte) (string, []common.TranslationData, error)); ok {
...
func (_c *MockTranslationsProvider_ProcessWebhook_Call) Return(collection string, data []common.TranslationData, err error) *MockTranslationsProvider_ProcessWebhook_Call {
	_c.Call.Return(collection, data, err)
	return _c
}

func (_c *MockTranslationsProvider_ProcessWebhook_Call) RunAndReturn(run func(context.Context, string, []byte) (string, []common.TranslationData, error)) *MockTranslationsProvider_ProcessWebhook_Call {
	_c.Call.Return(run)
	return _c
}
